...
const drawTicks = (ctx, origin, {jmax, zyc, data, dataPoint}, lengthX, lengthY) => {
...
const drawCrosshair = (ctx, origin, {jmax, data, dataPoint}, lengthX, lengthY) => {
...
const AngularPlot = ({ data, setDataPoint }) => {
   const updateDataPoint = (ctx, mouseInfo, data) => {
      ...
      const theAdjust = Math.floor((clickLocation.x - origin.x) / lengthX * data.jmax);
